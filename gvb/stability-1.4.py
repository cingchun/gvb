...
#      File Name:   stability.py
#           Mail:   qingchun720@foxmail.com
#   Created Time:   20:37 2018/6/13
#
...
def rhf_stability(mf, internal=True, external=True, verbose=None):
    '''
    ...
    '''
    mo_i = mo_e = stable_i = stable_e = None
    if internal:
...
def rohf_internal(mf, with_symmetry=True, verbose=None):
    ...
    if e < -1e-5:
        ...
        stable_i=False # added by qingchun 0828/2018
        mo = _rotate_mo(mf.mo_coeff, mf.mo_occ, v)
    else:
        log.note('ROHF wavefunction is stable in the internal stability analysis')
        stable_i = True  # added by qingchun 0828/2018
        mo = mf.mo_coeff
    return mo, stable_i

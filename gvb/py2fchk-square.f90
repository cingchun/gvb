...
! This subroutine is designed to be imported as a module by Python. Use
! -----------------------------------------------------------------------
!  f2py -m py2fchk -c py2fchk.f90 --fcompiler=intelem --compiler=intelem
! -----------------------------------------------------------------------
!  for INTEL compiler, or use
! --------------------------------
...
subroutine py2fchk(fchkname,nbf,coeff2,ab)
 implicit none
 integer i, k
...
!f2py intent(in) :: fchkname
 ...
 real(kind=8) coeff2(nbf,nbf)
!f2py intent(in,copy) :: coeff2
!f2py depend(nbf) coeff2

...
# def ncore(mol):       # added by qingchun 0515/2018
#     '''
...
#         else: n+=5
#     return n
# def nrefobt(mol):    # added by qingchun 0531/2018
#     from pyscf import gto
#     return (gto.copy(mol).build(basis='sto-6g', cart=False)).nao_nr()
